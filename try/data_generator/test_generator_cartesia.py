...
test_text = "Xin chào, đây là test với Cartesia TTS provider"
...
test_text_items = make_text_items(texts, method="incremental", prefix=None, pad=5, deduplicate=True, keep="first")
save_items_to_tsv_txt(test_text_items, "/home/nampv1/projects/tts/speech-synth-engine/try/try_output/data_generator/test_generator_cartesia/test_text_items.txt")
print(test_text_items[:5])


# Build GenerationConfig
credentials_cfg = CredentialsConfig(
    api_keys=[
        "sk_car_kyo1L9tkE8H6khB2eL1fTV"
    ],
...
output_dir = f"/home/nampv1/projects/tts/speech-synth-engine/try/try_output/data_generator/test_generator_cartesia/{current_time}"
...
# Summary is printed by DatasetGenerator._log_summary()
